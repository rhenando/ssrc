<?php
// Redirect to Arabic header if needed (Elementor Compatibility)
if ( function_exists('ssrc_is_arabic') && ssrc_is_arabic() ) {
    get_template_part('header', 'ar');
    return;
}
?>
<!DOCTYPE html>
...
<head>
  ...
  <!-- Google Fonts — DM Sans (EN) + Playfair Display (headings) + Cairo (AR) -->
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@700;800&family=DM+Sans:wght@400;500;600;700&family=Cairo:wght@400;600;700;800&display=swap" rel="stylesheet">
...
<body <?php body_class('font-body text-text bg-white'); ?>>
<?php wp_body_open(); ?>

<a class="skip-link screen-reader-text" href="#main"><?php esc_html_e( 'Skip to content', 'ssrc' ); ?></a>

<div id="page">

  <!-- ═══ NAVBAR ═══ -->
  <header id="masthead" class="bg-navy border-b-[3px] border-teal sticky top-0 left-0 w-full z-[999] shadow-nav">
    <div class="max-w-[1200px] mx-auto px-6 md:px-10 h-[66px] flex items-center">
      ...
      <?php wp_nav_menu([
        ...
        'fallback_cb'    => function() {
          ...
          $items = ['/' => 'Home', '/about' => 'About', '/services' => 'Services', '/engineering' => 'Engineering', '/downloads' => 'Downloads', '/contact' => 'Contact'];
      ...
      <!-- CTA button -->
      <div class="flex-shrink-0 ml-5 hidden md:block">
        <a href="<?php echo esc_url( ssrc_lang_url('/contact') ); ?>"
          ...
          <?php esc_html_e('Get in Touch', 'ssrc'); ?>
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
        </a>
      </div>

      <!-- Language switcher -->
      <div class="flex items-center gap-0.5 flex-shrink-0 ml-3 pl-3 border-l border-white/20"
           role="navigation" aria-label="Language switcher">
        <?php
        ...
        ?>
          <a href="<?php echo $url; ?>"
             class="<?php echo $cls; ?> text-[.72rem] tracking-[.8px] px-1.5 py-1 hover:text-white/90 transition-colors"
      ...
      <button class="menu-toggle md:hidden flex-shrink-0 ml-3 flex items-center justify-center min-w-[44px] min-h-[44px] bg-transparent border-2 border-white/40 rounded-md text-white hover:border-teal hover:bg-teal/15 transition-all"
              aria-expanded="false">
    ...
    <div class="md:hidden hidden w-full flex-col border-t border-white/10 px-5 pb-3" data-mobile-nav>
      <?php
      $mobile_items = ['/' => 'Home', '/about' => 'About', '/services' => 'Services', '/engineering' => 'Engineering', '/downloads' => 'Downloads', '/contact' => 'Contact'];
