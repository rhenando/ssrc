...
.download-card::before { content:''; position:absolute; top:0; left:0; right:0; height:4px; background:linear-gradient(90deg,#003366,#008080); transform:scaleX(0); transition:transform .3s; transform-origin:left; border-radius:4px 4px 0 0; }
...
<section class="bg-gray-light px-6 md:px-10 py-16 md:py-20">
  <div class="max-w-[1100px] mx-auto">
    <div class="text-center mb-12">
      <span class="text-teal text-[.72rem] font-bold uppercase tracking-[2px]">Downloads</span>
      <h1 class="font-head text-[clamp(2rem,4vw,3rem)] font-extrabold text-navy mt-2 mb-4">Download Center</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-[840px] mx-auto">
      ...
      ?>
        <article class="download-card relative bg-white border border-border rounded-2xl px-7 py-8 overflow-hidden transition-transform duration-300 hover:-translate-y-1 hover:shadow-card">
          ...
          <p class="text-sm text-muted leading-[1.7] mb-6"><?php echo esc_html( $download['description'] ); ?></p>
