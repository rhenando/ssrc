...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    image: "/images/2026/04/hussam.png",
    group: "engineering",
    bios: {
  ...
  },
  {
    ...
    image: "/images/2026/04/mohamed.png",
    group: "engineering",
    bios: {
  ...
  },
  {
    ...
    image: "/images/2026/04/samir.png",
    group: "engineering",
    bios: {
  ...
  },
  {
    ...
    image: "/images/2026/04/ahmad.png",
    group: "engineering",
    bios: {
  ...
  },
  {
    ...
    image: "/images/2026/04/raghid.png",
    group: "engineering",
    bios: {
...
export const engineeringProjects: EngineeringProject[] = [
  {
    ...
    descriptions: {
      en: "Marine reclamation works and shore protection design for 4,400,000 m2 land development.",
      ar: "أعمال الاستصلاح البحري وتصميم الحماية الساحلية لتطوير أراض بمساحة 4,400,000 م2."
    },
    color: "#6dc14a",
    images: [`${engineeringImageBase}/tharwat2.png`, `${engineeringImageBase}/tharwat1.png`, `${engineeringImageBase}/projects experience3.png`]
  },
  {
    ...
    descriptions: {
      en: "Concept master plan for the Saudi Side new Island as a commercial and entertainment hub.",
      ar: "إعداد وتصميم مخطط رئيسي مفاهيمي لتطوير الجزيرة الجديدة كمركز تجاري وترفيهي."
    },
    color: "#6dc14a",
    images: [`${engineeringImageBase}/concept1.png`, `${engineeringImageBase}/projects experience5.png`]
  },
  {
    slug: "king-salman-reservation",
    categories: { en: "Architectural & Building", ar: "المعماري والبناء" },
    titles: { en: "King Salman Reservation - Tubaiq", ar: "محمية الملك سلمان - تبوق" },
    locations: { en: "Saudi Arabia", ar: "المملكة العربية السعودية" },
    descriptions: {
      en: "Master plan and architectural concept for a major facilities and theme park project.",
      ar: "إعداد المخطط الرئيسي والتصميم المعماري المفاهيمي ومتنزه الألعاب لمشروع مرموق."
    },
    color: "#a78bfa",
    images: [`${engineeringImageBase}/architectural1.png`]
  },
  {
    slug: "oxagon-terminal",
    categories: { en: "Structural & Building", ar: "الإنشاءات والبناء" },
    titles: { en: "Oxagon Terminal Warehouse - NEOM", ar: "مستودع أوكساجون الطرفي - نيوم" },
    locations: { en: "Saudi Arabia", ar: "المملكة العربية السعودية" },
    descriptions: {
      en: "Structural modeling for a highly technical warehouse measuring 500m x 450m x 85m.",
      ar: "النمذجة الإنشائية لتصميم مستودع عالي التقنية بأبعاد 500م x 450م x 85م."
    },
    color: "#f9a825",
    images: [`${engineeringImageBase}/oxagon2.png`]
  },
  {
    slug: "pipe-stress-analysis",
    categories: { en: "MEP / Infrastructure", ar: "المرافق والبنية التحتية" },
    titles: { en: "Pipe Stress Analysis & Vibration Model", ar: "تحليل إجهاد الأنابيب ونموذج الاهتزاز" },
    locations: { en: "Jubail, Saudi Arabia", ar: "الجبيل، المملكة العربية السعودية" },
    descriptions: {
      en: "Pipe stress analysis by CAESAR-II for pipelines and process equipment installations.",
      ar: "تحليل إجهاد الأنابيب باستخدام CAESAR-II لعدة خطوط أنابيب وتركيبات معدات العمليات."
    },
    color: "#4fc3f7",
    images: [`${engineeringImageBase}/projects experience13.png`]
  },
  {
    slug: "qgwp-piping-design",
    categories: { en: "MEP / Infrastructure", ar: "المرافق والبنية التحتية" },
    titles: { en: "QGWP Detailed Piping Design", ar: "تصميم الأنابيب التفصيلي - QGWP" },
    locations: { en: "Qatar (with Veolia ME)", ar: "قطر (مع Veolia ME)" },
    descriptions: {
      en: "Detailed piping design, stress analysis, structural modeling, fabrication drawings, skids, supports, foundations, and platform design.",
      ar: "التصميم التفصيلي لنظام الأنابيب وتحليل الإجهاد والنمذجة الإنشائية ورسومات التصنيع والدعامات والمنصات."
    },
    color: "#4fc3f7",
    images: [`${engineeringImageBase}/projects experience14.png`]
  },
  {
    slug: "cornish-al-khobar",
    categories: { en: "Urban Development", ar: "التطوير العمراني" },
    titles: { en: "Cornish Al-Khobar Development Marine Works", ar: "أعمال كورنيش الخبر البحرية" },
    locations: { en: "Al-Khobar, Saudi Arabia", ar: "الخبر، المملكة العربية السعودية" },
    descriptions: {
      en: "Design, reclamation, shore protection, and ground improvement for 3,000,000 m2 of new development.",
      ar: "تصميم الاستصلاح والحماية الساحلية وتحسين التربة لتطوير 3,000,000 م2."
    },
    color: "#6dc14a",
    images: [`${engineeringImageBase}/cornish1.png`, `${engineeringImageBase}/projects experience9.png`]
  },
  {
    slug: "building-cost-engineering",
    categories: { en: "Architectural & Building", ar: "المعماري والبناء" },
    titles: { en: "Building Project Cost Engineering", ar: "هندسة تكلفة مشاريع البناء" },
    locations: { en: "Mekkah, Saudi Arabia", ar: "مكة المكرمة، المملكة العربية السعودية" },
    descriptions: {
      en: "BOQs, material specifications, tender design support, finishing review, and life safety planning for a major building complex.",
      ar: "إعداد جداول الكميات والمواصفات ودعم التصميم للمناقصة ومراجعة التشطيبات وخطط السلامة."
    },
    color: "#a78bfa",
    images: [`${engineeringImageBase}/projects experience15.png`]
  },
  {
    slug: "stc-structural-assessment",
    categories: { en: "Structural & Assessment", ar: "الإنشاءات والتقييم" },
    titles: { en: "Structural Assessment - STC Sites", ar: "التقييم الإنشائي - مواقع STC" },
    locations: { en: "Saudi Arabia", ar: "المملكة العربية السعودية" },
    descriptions: {
      en: "Structural assessment for up to 40 exchange buildings including repairs, strengthening measures, and design supervision.",
      ar: "التقييم الإنشائي لما يصل إلى 40 مبنى مع أعمال الإصلاح والتقوية والإشراف التصميمي."
    },
    color: "#f9a825",
    images: [`${engineeringImageBase}/structural1.png`, `${engineeringImageBase}/projects experience16.png`]
  },
  {
    ...
    locations: { en: "Riyadh, Saudi Arabia", ar: "الرياض، المملكة العربية السعودية" },
    descriptions: {
      en: "Structural design, connection design, shop drawing preparation, and Tekla model development.",
      ar: "التصميم الإنشائي وإعداد رسومات التصنيع وتطوير نموذج Tekla ثلاثي الأبعاد."
    },
    color: "#f9a825",
    images: [`${engineeringImageBase}/riyadh1.png`]
  },
  {
    slug: "shop-fabrication-drawings",
    categories: { en: "Design & Documentation", ar: "التصميم والتوثيق" },
    titles: { en: "Shop & Fabrication Drawings", ar: "رسومات الورشة والتصنيع" },
    locations: { en: "Various Locations", ar: "مواقع متعددة" },
    descriptions: {
      en: "Shop and fabrication drawing packages covering structural steel, MEP systems, equipment skids, and fabrication specifications.",
      ar: "حزم رسومات ورشة وتصنيع شاملة تغطي الفولاذ الإنشائي وأنظمة MEP والمعدات."
    },
    color: "#f48fb1",
    images: [
      `${engineeringImageBase}/plenty1.png`,
      `${engineeringImageBase}/plenty2.png`,
      `${engineeringImageBase}/plenty3.png`,
      `${engineeringImageBase}/plenty4.png`,
      `${engineeringImageBase}/plenty5.png`
    ]
  }
];
